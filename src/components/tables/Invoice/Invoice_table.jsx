...
const Datatable = () => {
    ...
    const activate = async (item) => {
        const { data } = await axios.post(`/invoice/activate/${item._id}`, { invoiceType: item.invoiceType })
        if (data.success) {
            getInvoiceTemps()
            Swal.fire({
                icon: "success",
    ...
    const editInvoice = async () => {
        try {
            ...
            newLogo ? formdata.append("avatar", logo[0]) : formdata.append("oldAvatar", logo)
            formdata.append("newThumbnail", newStamp)
            newStamp ? formdata.append("thumbnail", stamp[0]) : formdata.append("oldThumbnail", stamp)
            formdata.append("name", company)
            formdata.append("social", facebook)
            formdata.append("address", address)
            formdata.append("email", email)
            ...
            const { data } = await axios.post(`/invoice/editInvoice/${editID}`, formdata)
            if (!data.success) {
                setLoading(false)
                Swal.fire({
                    icon: "error",
                    ...
                    <div className="w-full p-2 ">
                        ...
                        <div className="w-[595px] bg-white h-[842px] mx-auto drop-shadow-2xl p-4 flex flex-wrap justify-start items-start">
                            <div className="w-3/6 h-[330px]">
                                ...
                                <div className="w-full h-[74px] p-2">
                            ...
                            <div className="w-3/6  h-[330px] flex justify-start items-end flex-col p-1">
                                <div className="w-full flex justify-start items-end flex-col p-1">
                                    <h1 className="text-sm w-full font-bold break-words">{company}</h1>
                            ...
                            <div className="w-full h-[200px] border-b-4 border-b-black relative">
                                ...
                                <div className="w-full flex flex-col justify-center items-end">
                                    ...
                                    <div className="flex gap-1">
                                        <h1 className="text-xs font-bold">Санхүүгийн албаны дарга:</h1>
                                        <h1 className="text-xs">
                                            /................................................................/........................./
                                        </h1>
                                    </div>
                ...
                return (
                    <div className="w-full p-2 flex justify-between items-start">
                        <div className="p-2 w-2/6 ">
                            ...
                            }} type={"file"} className="w-full border p-1 rounded-md mt-1" />
                            <label>Тамга</label>
                            <input onChange={(e) => {
                                if (e.target?.files) {
                            ...
                            <input value={company} onChange={(e) => setCompany(e.target.value)} type={"text"} placeholder="Компаны нэр" className="w-full border p-1 rounded-md mt-1" />
                            <input value={address} onChange={(e) => setAddress(e.target.value)} type={"text"} placeholder="Хаяг" className="w-full border p-1 rounded-md mt-1" />
                            <input value={email} onChange={(e) => setEmail(e.target.value)} type={"text"} placeholder="Цахим хаяг" className="w-full border p-1 rounded-md mt-1" />
                            <input value={number} onChange={(e) => setNumber(e.target.value)} type={"text"} placeholder="Утас" className="w-full border p-1 rounded-md mt-1" />
                            <input value={website} onChange={(e) => setWebsite(e.target.value)} type={"text"} placeholder="Веб" className="w-full border p-1 rounded-md mt-1" />
                            <input value={facebook} onChange={(e) => setFacebook(e.target.value)} type={"text"} placeholder="Сошиал хаяг" className="w-full border p-1 rounded-md mt-1" />
                            <select value={invoiceType} onChange={(e) => setInvoiceType(e.target.value)} className="w-full border rounded-md p-1 mt-1">
                            ...
                            <input value={bank} onChange={(e) => setBank(e.target.value)} type={"text"} placeholder="Банкы нэр" className="w-full border p-1 rounded-md mt-1" />
                            <input value={bankAccount} onChange={(e) => setBankAccount(e.target.value)} type={"text"} placeholder="Дансны дугаар" className="w-full border p-1 rounded-md mt-1" />
                    ...
                    <div className="w-full flex flex-wrap">
                        {
                            invoiceList.length !== 0 ?
                                invoiceList?.map((item, index) => (
                                    <div className={`w-[180px] h-[400px] flex flex-col p-2 justify-center items-center bg-white drop-shadow-xl rounded-md ${item.inUse && "bg-green-300"} m-2`}>
                                        <div className="w-full rounded-md bg-white/50 h-12 absolute top-0 flex justify-center items-center">
                                            ...
                                            <button onClick={() => activate(item)} className={`w-3/6 h-full ${item.inUse ? "hover:bg-red-400" : "hover:bg-green-400"} ${item.inUse && "text-green-400"} rounded-md flex justify-center items-center hover:text-white text-2xl`}>
                                                <BsCheckCircleFill />
                                            </button>
                                        </div>
                                        ...
                                        <div key={index} className="w-[120px] bg-white h-[200px] mx-auto p-1 flex flex-wrap justify-start items-start">
                                            <div className="w-3/6 h-[55px]">
                                                ...
                                                <div className="w-full h-[12px] p-2">
                                            ...
                                            <div className="w-3/6  h-[55px] flex justify-start items-end flex-col p-1">
                                                <div className="w-full flex justify-start items-end flex-col p-1">
                                                    <h1 className="text-[2px] w-full font-bold break-words">{item.name}</h1>
                                                    <div className="w-full flex flex-col">
                                                        <div className="flex w-full justify-start items-start">
                                                            <h1 className="text-[2px] font-bold">Хаяг:</h1>
                                                            <h1 className="text-[2px] break-words">{item.address}</h1>
                                                        </div>
                                                        <div className="flex w-full justify-start items-start">
                                                            <h1 className="text-[2px] font-bold">
                                                                Цахим хаяг:
                                                            </h1>
                                                            <h1 className="text-[2px] break-words">{item.email}</h1>
                                                        </div>
                                                        <div className="flex w-full justify-start items-start">
                                                            <h1 className="text-[2px] font-bold">
                                                                Утас:
                                                            </h1>
                                                            <h1 className="text-[2px] break-words">{item.number}</h1>
                                                        </div>
                                                        <div className="flex w-full justify-start items-start">
                                                            <h1 className="text-[2px] font-bold">
                                                                Веб:
                                                            </h1>
                                                            <h1 className="text-[2px] break-words"  >{item.website}</h1>
                                                        </div>
                                                        <div className="flex w-full justify-start items-start">
                                                            <h1 className="text-[2px] font-bold">
                                                                Сошиал хаяг:
                                                            </h1>
                                                            <h1 className="text-[2px]  break-words">{item.social}</h1>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="w-full flex justify-start items-start flex-col p-2">
                                            ...
                                            <div className="w-full h-[33px] border-b-2 border-b-black relative">
                                                ...
                                                <div className="w-full flex flex-col justify-center items-end">
                                                    <div className="flex gap-1">
                                                        <h1 className="text-[2px] font-bold">Хүлээн авсан:</h1>
                                                        <h1 className="text-[2px]">
                                                            /................................................................/........................./
                                                        </h1>
                                                    </div>
                                                    <div className="flex gap-1">
                                                        <h1 className="text-[2px] font-bold">Нягтлан бодсон:</h1>
                                                        <h1 className="text-[2px]">
                                                            /................................................................/........................./
                                                        </h1>
                                                    </div>
                                                    <div className="flex gap-1">
                                                        <h1 className="text-[2px] font-bold">Санхүүгийн албаны дарга:</h1>
                                                        <h1 className="text-[2px]">
                                                            /................................................................/........................./
                                                        </h1>
                                                    </div>
                                                    <div className="flex gap-1">
                                                        <h1 className="text-[2px] font-bold">Гүйцэтгэх захирал:</h1>
                                                        <h1 className="text-[2px]">
                                                            /................................................................/........................./
                                                        </h1>
                                                    </div>
                                        ...
                                        <div className="w-full rounded-md bg-white/50 h-12 absolute bottom-0 flex justify-center items-center">
                                            <button onClick={() => setUpView(item)} className="w-2/6 h-full hover:bg-blue-400 rounded-md flex justify-center items-center hover:text-white text-2xl ">
                                                <AiOutlineFolderView />
                                            </button>
                                            <button onClick={() => setUpEdit(item)} className="w-2/6 h-full hover:bg-yellow-400 rounded-md flex justify-center items-center hover:text-white text-2xl">
                                                <TbEdit />
                                            </button>
                                            <button onClick={() => removeInvoice(item)} className="w-2/6 h-full hover:bg-red-400 rounded-md flex justify-center items-center hover:text-white text-2xl">
                                                <MdDeleteForever />
                                            </button>
                                        </div>
                                    </div>
                ...
                return (
                    <div className="w-full p-2 flex justify-between items-start">
                        <div className="p-2 w-2/6 ">
                            ...
                            <input value={website} onChange={(e) => setWebsite(e.target.value)} type={"text"} placeholder="Веб" className="w-full border p-1 rounded-md mt-1" />
                            <input value={facebook} onChange={(e) => setFacebook(e.target.value)} type={"text"} placeholder="Сошиал хаяг" className="w-full border p-1 rounded-md mt-1" />
                            <input value={invoiceType} onChange={(e) => setInvoiceType(e.target.value)} type={"text"} placeholder="Төрөл бичих" className="w-full border p-1 rounded-md mt-1" />
                            <select value={invoiceType} onChange={(e) => setInvoiceType(e.target.value)} className="w-full border rounded-md p-1 mt-1">
                                <option label="Төрөл сонгох" value={"notchosen"} />
                                <option label="НЭХЭМЖЛЭХ" value={"НЭХЭМЖЛЭХ"} />
                                <option label="ҮНИЙН САНАЛ" value={"ҮНИЙН САНАЛ"} />
